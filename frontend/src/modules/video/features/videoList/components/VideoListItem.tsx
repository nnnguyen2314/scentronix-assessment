...
import {Avatar, Card, Space, Tag, Typography, Image} from "antd";
...
const VideoListItem: React.FC<VideoListItemProps> = (props: VideoListItemProps) => {
    ...
    return (
        ...
        >
            <div>
                {!videoData?.video?.snippet?.thumbnails && (
                    <Image
                        width="100%"
                        height="auto"
                        src="error"
                ...
                {videoData?.video?.snippet?.thumbnails && (
                    <Image
                        src={videoData?.video?.snippet?.thumbnails?.high.url}
                        width={videoData?.video?.snippet?.thumbnails?.high.width}
                        height={videoData?.video?.snippet?.thumbnails?.high.height}
                        preview={false}
                    />
                )}
            </div>
